// This go file was taken from the GitHub user pocke (https://github.com/pocke). He's already written a repository to handle the Google Calendar API from the command line. I guess I'm just trying to copy him :)
